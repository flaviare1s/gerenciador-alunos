      ...
      <div className="bg-white rounded-lg shadow-lg p-6 w-96 max-w-[90%]">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-dark-gray mb-6 text-center">
            O banco de dados <strong>Supabase</strong> está temporariamente pausado.
            As funcionalidades da aplicação podem estar limitadas no momento.
          </p>
          <p className="text-sm text-dark-gray mb-6 text-center">
            Para testar a aplicação, você pode executá-la localmente seguindo as instruções no{' '}
            <a
              href="https://github.com/flaviare1s/gerenciador-alunos"
              target="_blank"
